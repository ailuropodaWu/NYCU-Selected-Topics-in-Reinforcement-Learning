...
class AtariDQNAgent(DQNBaseAgent):
	def __init__(self, config):
		...
		# self.behavior_net.load_state_dict(torch.load('./log/DQN/Enduro/model_53360503_1716.pth'))
		self.behavior_net.load_state_dict(torch.load('./log/DQN/MsPacman/model_21374528_5064.pth'))
